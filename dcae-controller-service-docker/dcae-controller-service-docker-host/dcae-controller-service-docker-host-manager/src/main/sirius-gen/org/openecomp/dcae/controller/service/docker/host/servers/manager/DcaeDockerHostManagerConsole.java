...
import org.openecomp.dcae.controller.service.docker.host.servers.manager.gui.DcaeGuiClientApiConsole;   


public class DcaeDockerHostManagerConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeDockerHostManagerConsole.class);
    protected DcaeDockerHostManagerClient controller;
    
    
        DcaeGuiClientApiConsole gui;   


    public DcaeDockerHostManagerConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeDockerHostManagerClient(filename,name);
            client = controller.client;
    
            gui = new  DcaeGuiClientApiConsole(filename,name);   
    }
    
	public DcaeDockerHostManagerConsole(AbstractClient c) {
        controller = new DcaeDockerHostManagerClient(c);
        client = controller.client;
    }
