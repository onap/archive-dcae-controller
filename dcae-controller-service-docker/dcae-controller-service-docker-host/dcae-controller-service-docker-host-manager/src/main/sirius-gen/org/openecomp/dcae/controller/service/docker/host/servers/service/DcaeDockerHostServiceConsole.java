...
public class DcaeDockerHostServiceConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeDockerHostServiceConsole.class);
    protected DcaeDockerHostServiceClient controller;
    



    public DcaeDockerHostServiceConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeDockerHostServiceClient(filename,name);
            client = controller.client;

    }
    
	public DcaeDockerHostServiceConsole(AbstractClient c) {
        controller = new DcaeDockerHostServiceClient(c);
        client = controller.client;
    }
