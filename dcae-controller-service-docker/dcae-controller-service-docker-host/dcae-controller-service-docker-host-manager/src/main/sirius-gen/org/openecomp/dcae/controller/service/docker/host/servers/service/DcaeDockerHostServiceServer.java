...
public class DcaeDockerHostServiceServer implements ISiriusServer, IRequestHandler {
    public static final Logger logger = Logger.getLogger(DcaeDockerHostServiceServer.class);
    String serverPath;
    ManagementServer server;
    DcaeDockerHostService controller;
...
//      LocationControllerApi api ;
    ...
    public DcaeDockerHostServiceServer(String filename) throws IOException {
        ...
        server = new ManagementServer(f, "DockerHostService", serverPath, filename);
    ...
    public void runWebserver() throws IOException {
        controller = (DcaeDockerHostService) server.find("/").o;
    ...
    public static void main(String []args) throws IOException {
            ...
            DcaeDockerHostServiceServer s = new DcaeDockerHostServiceServer("service.properties");
            s.runWebserver();
    }
	public DockerHostService getController() {
		return controller;
	}
