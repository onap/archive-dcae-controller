...
public class ManagerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ManagerPackage.DOCKER_HOST_MANAGER: {
				DockerHostManager dockerHostManager = (DockerHostManager)theEObject;
				T result = caseDockerHostManager(dockerHostManager);
				if (result == null) result = caseVirtualMachineManager(dockerHostManager);
				if (result == null) result = caseDockerConfiguration(dockerHostManager);
				if (result == null) result = caseDcaeManager(dockerHostManager);
				if (result == null) result = caseAbstractManagementServer(dockerHostManager);
				if (result == null) result = caseSouthBoundApiWithProxy(dockerHostManager);
				if (result == null) result = caseSouthBoundApi(dockerHostManager);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Docker Host Manager</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Docker Host Manager</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDockerHostManager(DockerHostManager object) {
		return null;
	}
