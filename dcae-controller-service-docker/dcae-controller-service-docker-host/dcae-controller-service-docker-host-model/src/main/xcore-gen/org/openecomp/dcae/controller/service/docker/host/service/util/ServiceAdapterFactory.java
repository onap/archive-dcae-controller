...
public class ServiceAdapterFactory extends AdapterFactoryImpl {
	...
	protected ServiceSwitch<Adapter> modelSwitch =
		new ServiceSwitch<Adapter>() {
			@Override
			public Adapter caseDockerHostService(DockerHostService object) {
				return createDockerHostServiceAdapter();
			}
			@Override
			public Adapter caseDockerHostServiceInstance(DockerHostServiceInstance object) {
				return createDockerHostServiceInstanceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.dcae.controller.service.docker.host.service.DockerHostService <em>Docker Host Service</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDockerHostServiceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.dcae.controller.service.docker.host.service.DockerHostServiceInstance <em>Docker Host Service Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDockerHostServiceInstanceAdapter() {
		return null;
	}
