...
public class DockerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DockerPackage.DOCKER_SERVICE: {
				DockerService dockerService = (DockerService)theEObject;
				T result = caseDockerService(dockerService);
				if (result == null) result = caseDcaeService(dockerService);
				if (result == null) result = caseNamedEntity(dockerService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockerPackage.DOCKER_SERVICE_INSTANCE: {
				DockerServiceInstance dockerServiceInstance = (DockerServiceInstance)theEObject;
				T result = caseDockerServiceInstance(dockerServiceInstance);
				if (result == null) result = caseDcaeServiceInstance(dockerServiceInstance);
				if (result == null) result = caseNamedEntity(dockerServiceInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DockerPackage.DOCKER_CONFIGURATION: {
			...
			case DockerPackage.DOCKER_SERVICE_DESCRIPTOR: {
				DockerServiceDescriptor dockerServiceDescriptor = (DockerServiceDescriptor)theEObject;
				T result = caseDockerServiceDescriptor(dockerServiceDescriptor);
				if (result == null) result = caseDcaeServiceDescriptor(dockerServiceDescriptor);
				if (result == null) result = caseNamedEntity(dockerServiceDescriptor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDockerServiceDescriptor(DockerServiceDescriptor object) {
		return null;
	}
