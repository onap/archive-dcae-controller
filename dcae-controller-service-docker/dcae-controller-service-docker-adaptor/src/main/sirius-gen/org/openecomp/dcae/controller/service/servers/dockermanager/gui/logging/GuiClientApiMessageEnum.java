...
package org.openecomp.dcae.controller.service.servers.dockermanager.gui.logging;
...
public enum GuiClientApiMessageEnum implements EcompMessageEnum {
  ...
  REMOTE_CALL_FAILED_getGraph;
	...
	static {
		EELFResourceManager.loadMessageBundle("org/openecomp/dcae/controller/service/servers/dockermanager/gui/logging/GuiClientApi");
	}
}
