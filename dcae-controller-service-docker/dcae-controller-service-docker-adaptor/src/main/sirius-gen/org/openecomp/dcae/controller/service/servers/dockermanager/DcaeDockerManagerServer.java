...
import org.openecomp.dcae.controller.service.servers.dockermanager.gui.DcaeModelFactory;





public class DcaeDockerManagerServer implements ISiriusServer, IRequestHandler {
    public static final Logger logger = Logger.getLogger(DcaeDockerManagerServer.class);
    String serverPath;
    ManagementServer server;
    DcaeDockerManager controller;
    String directory = "data";
//      LocationControllerApi api ;
    Jetty8Server webServer;
    DcaeDockermanagerFactory f = new DcaeDockermanagerFactory(this);
    ...
    public DcaeDockerManagerServer(String filename) throws IOException {
        ...
        server = new ManagementServer(f, "DockerManager", serverPath, filename);
		...
		server.addFactory(org.openecomp.dcae.controller.service.docker.DockerFactory.eINSTANCE);
    ...
    public void runWebserver() throws IOException {
        controller = (DcaeDockerManager) server.find("/").o;
        webServer = new Jetty8Server("dockermanager.properties");
    ...
    public static void main(String []args) throws IOException {
            ...
            DcaeDockerManagerServer s = new DcaeDockerManagerServer("dockermanager.properties");
            s.runWebserver();
    }
	public DockerManager getController() {
		return controller;
	}
