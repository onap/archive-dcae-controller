...
import org.openecomp.dcae.controller.service.servers.dockermanager.gui.DcaeGuiClientApiConsole;   


public class DcaeDockerManagerConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeDockerManagerConsole.class);
    protected DcaeDockerManagerClient controller;
    
    
        DcaeGuiClientApiConsole gui;   


    public DcaeDockerManagerConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeDockerManagerClient(filename,name);
            client = controller.client;
    
            gui = new  DcaeGuiClientApiConsole(filename,name);   
    }
    
	public DcaeDockerManagerConsole(AbstractClient c) {
        controller = new DcaeDockerManagerClient(c);
        client = controller.client;
    }
