...
public class DcaeDockerService extends DockerServiceImpl implements ISiriusPlugin {
	...
	public void deploy(java.lang.String instanceName, java.lang.String containerPath) {
		...
		ecomplogger.setOperation(DockerServiceOperationEnum.deploy);
		try {
	...
	public void undeploy(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.undeploy);
		try {
	...
	public org.openecomp.dcae.controller.core.service.HealthTestResponse test(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.test);
		try {
	...
	public void suspend(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.suspend);
		try {
	...
	public void resume(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.resume);
		try {
	...
	public void pushManagerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.pushManagerConfiguration);
		try {
	...
	public void pollManagerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.pollManagerConfiguration);
		try {
	...
	public org.eclipse.emf.ecore.EObject managerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.managerConfiguration);
		try {
	...
	public org.json.JSONObject managerOperation(java.lang.String instanceName, java.lang.String operation, org.json.JSONObject parameters) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.managerOperation);
		try {
	...
	public void updateConfigurationFromPolicy(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.updateConfigurationFromPolicy);
		try {
	...
	public void runHealthTests() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerServiceOperationEnum.runHealthTests);
		try {
