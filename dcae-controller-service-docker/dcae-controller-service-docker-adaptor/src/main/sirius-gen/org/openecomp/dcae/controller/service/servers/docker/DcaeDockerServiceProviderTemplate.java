...
public class DcaeDockerServiceProviderTemplate extends BasicAdaptorProvider {
	private static final Logger logger = Logger.getLogger(DcaeDockerServiceProviderTemplate.class);
	DockerService o;

	public DcaeDockerServiceProviderTemplate(ISiriusServer controller, DockerService o) {
		super(controller, o);
		this.o = o;
	}
