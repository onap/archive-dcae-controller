...
public class DcaeDockerManager extends DockerManagerImpl {
	...
	public org.openecomp.dcae.controller.core.service.HealthTestResponse test() {
		...
		ecomplogger.setOperation(DockerManagerOperationEnum.test);
		try {
			res =  controller.test();
		}
		catch (Exception e) {
	...
	public void suspend() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerManagerOperationEnum.suspend);
		try {
			 controller.suspend();
		}
		catch (Exception e) {
	...
	public void resume() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerManagerOperationEnum.resume);
		try {
			 controller.resume();
		}
		catch (Exception e) {
	...
	public java.lang.String publicKey() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerManagerOperationEnum.publicKey);
		try {
	...
	public void configurationChanged() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerManagerOperationEnum.configurationChanged);
		try {
	...
	public void updateStreams(EList<org.openecomp.dcae.controller.core.stream.DcaeStream> inputStreams, EList<org.openecomp.dcae.controller.core.stream.DcaeStream> outputStreams) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(DockerManagerOperationEnum.updateStreams);
		try {
	...
	public DcaeDockerManagerProvider getSomfProvider() {
		return controller;
	}
}
