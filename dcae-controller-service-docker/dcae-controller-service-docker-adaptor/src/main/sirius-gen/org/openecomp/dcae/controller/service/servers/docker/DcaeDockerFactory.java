...
import org.openecomp.dcae.controller.service.docker.impl.DockerFactoryImpl;





public class DcaeDockerFactory extends DockerFactoryImpl {
	public static final Logger logger = Logger.getLogger(DcaeDockerFactory.class);
	ISiriusServer server = null;
	@Override
	public EPackage getEPackage() { return DockerPackage.eINSTANCE; }
	public DcaeDockerFactory(ISiriusServer server) {
		this.server = server;
	}
	@Override
	public DockerService createDockerService() {
		return new DcaeDockerService(server);
	}
