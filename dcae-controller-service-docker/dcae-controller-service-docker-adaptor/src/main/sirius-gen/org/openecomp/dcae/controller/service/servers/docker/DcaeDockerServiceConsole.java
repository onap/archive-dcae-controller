...
public class DcaeDockerServiceConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeDockerServiceConsole.class);
    protected DcaeDockerServiceClient controller;
    



    public DcaeDockerServiceConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeDockerServiceClient(filename,name);
            client = controller.client;

    }
    
	public DcaeDockerServiceConsole(AbstractClient c) {
        controller = new DcaeDockerServiceClient(c);
        client = controller.client;
    }
