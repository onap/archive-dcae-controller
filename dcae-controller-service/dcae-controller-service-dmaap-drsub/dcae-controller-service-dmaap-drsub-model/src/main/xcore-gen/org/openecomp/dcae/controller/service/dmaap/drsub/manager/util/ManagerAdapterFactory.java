...
public class ManagerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ManagerSwitch<Adapter> modelSwitch =
		new ManagerSwitch<Adapter>() {
			@Override
			public Adapter caseControllerServiceDmaapDrsubManager(ControllerServiceDmaapDrsubManager object) {
				return createControllerServiceDmaapDrsubManagerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.dcae.controller.service.dmaap.drsub.manager.ControllerServiceDmaapDrsubManager <em>Controller Service Dmaap Drsub Manager</em>}'.
	 * <!-- begin-user-doc -->
