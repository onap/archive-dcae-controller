...
/**
 */
package org.openecomp.dcae.controller.service.dmaap.drsub.manager.util;
 ...
 * <!-- end-user-doc -->
 * @see org.openecomp.dcae.controller.service.dmaap.drsub.manager.ManagerPackage
 * @generated
 */
public class ManagerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ManagerPackage.CONTROLLER_SERVICE_DMAAP_DRSUB_MANAGER: {
				ControllerServiceDmaapDrsubManager controllerServiceDmaapDrsubManager = (ControllerServiceDmaapDrsubManager)theEObject;
				T result = caseControllerServiceDmaapDrsubManager(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseVirtualMachineManager(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseControllerServiceDmaapDrsubServiceConfiguration(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseDcaeManager(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseAbstractManagementServer(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseSouthBoundApiWithProxy(controllerServiceDmaapDrsubManager);
				if (result == null) result = caseSouthBoundApi(controllerServiceDmaapDrsubManager);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Controller Service Dmaap Drsub Manager</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Controller Service Dmaap Drsub Manager</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseControllerServiceDmaapDrsubManager(ControllerServiceDmaapDrsubManager object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Controller Service Dmaap Drsub Service Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Controller Service Dmaap Drsub Service Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseControllerServiceDmaapDrsubServiceConfiguration(ControllerServiceDmaapDrsubServiceConfiguration object) {
		return null;
	}
