...
public class DcaeControllerServiceDmaapDrsubServiceConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeControllerServiceDmaapDrsubServiceConsole.class);
    protected DcaeControllerServiceDmaapDrsubServiceClient controller;
    



    public DcaeControllerServiceDmaapDrsubServiceConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeControllerServiceDmaapDrsubServiceClient(filename,name);
            client = controller.client;

    }
    
	public DcaeControllerServiceDmaapDrsubServiceConsole(AbstractClient c) {
        controller = new DcaeControllerServiceDmaapDrsubServiceClient(c);
        client = controller.client;
    }
