...
public enum ControllerServiceDmaapDrsubServiceMessageEnum implements EcompMessageEnum {
  ...
  REMOTE_updateDeploymentStatus;
	...
	static {
		EELFResourceManager.loadMessageBundle("org.openecomp.dcae.controller.service.dmaap.drsub.servers.service.logging.ControllerServiceDmaapDrsubService");
	}
}
