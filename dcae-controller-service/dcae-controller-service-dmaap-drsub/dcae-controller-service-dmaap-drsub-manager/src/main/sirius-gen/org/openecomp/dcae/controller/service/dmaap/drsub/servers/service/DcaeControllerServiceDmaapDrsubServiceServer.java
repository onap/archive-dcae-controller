...
public class DcaeControllerServiceDmaapDrsubServiceServer implements ISiriusServer, IRequestHandler {
    public static final Logger logger = Logger.getLogger(DcaeControllerServiceDmaapDrsubServiceServer.class);
    String serverPath;
    ManagementServer server;
    DcaeControllerServiceDmaapDrsubService controller;
...
//      LocationControllerApi api ;
    ...
    public DcaeControllerServiceDmaapDrsubServiceServer(String filename) throws IOException {
        ...
        server = new ManagementServer(f, "ControllerServiceDmaapDrsubService", serverPath, filename);
    ...
    public void runWebserver() throws IOException {
        controller = (DcaeControllerServiceDmaapDrsubService) server.find("/").o;
    ...
    public static void main(String []args) throws IOException {
            ...
            DcaeControllerServiceDmaapDrsubServiceServer s = new DcaeControllerServiceDmaapDrsubServiceServer("service.properties");
            s.runWebserver();
    }
	public ControllerServiceDmaapDrsubService getController() {
		return controller;
	}
