...
public class DcaeControllerServiceStandardeventcollectorService extends ControllerServiceStandardeventcollectorServiceImpl implements ISiriusPlugin {
	...
	public void deploy(java.lang.String instanceName, java.lang.String containerPath) {
		...
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.deploy);
		try {
	...
	public void undeploy(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.undeploy);
		try {
	...
	public org.openecomp.dcae.controller.core.service.HealthTestResponse test(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.test);
		try {
	...
	public void suspend(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.suspend);
		try {
	...
	public void resume(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.resume);
		try {
	...
	public void pushManagerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.pushManagerConfiguration);
		try {
	...
	public void pollManagerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.pollManagerConfiguration);
		try {
	...
	public org.eclipse.emf.ecore.EObject managerConfiguration(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.managerConfiguration);
		try {
	...
	public org.json.JSONObject managerOperation(java.lang.String instanceName, java.lang.String operation, org.json.JSONObject parameters) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.managerOperation);
		try {
	...
	public void updateConfigurationFromPolicy(java.lang.String instanceName) {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.updateConfigurationFromPolicy);
		try {
	...
	public void runHealthTests() {
		...
		Date now_ = new Date();
		ecomplogger.recordMetricEventStart();
		ecomplogger.setOperation(ControllerServiceStandardeventcollectorServiceOperationEnum.runHealthTests);
		try {
	...
	public DcaeControllerServiceStandardeventcollectorServiceProvider getSomfProvider() {
		return controller;
	}
}
