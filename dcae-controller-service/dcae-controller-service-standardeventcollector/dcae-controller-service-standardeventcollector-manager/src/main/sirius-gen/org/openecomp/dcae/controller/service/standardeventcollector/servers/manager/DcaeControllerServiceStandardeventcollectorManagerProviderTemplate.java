...
public class DcaeControllerServiceStandardeventcollectorManagerProviderTemplate extends DcaeDockerManagerProvider {
	private static final Logger logger = Logger.getLogger(DcaeControllerServiceStandardeventcollectorManagerProviderTemplate.class);
	ControllerServiceStandardeventcollectorManager o;

	public DcaeControllerServiceStandardeventcollectorManagerProviderTemplate(ISiriusServer controller, ControllerServiceStandardeventcollectorManager o) {
		super(controller, o);
		this.o = o;
	}
