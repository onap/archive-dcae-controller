...
import org.openecomp.dcae.controller.service.standardeventcollector.servers.manager.gui.DcaeModelFactory;





public class DcaeControllerServiceStandardeventcollectorManagerServer implements ISiriusServer, IRequestHandler {
    public static final Logger logger = Logger.getLogger(DcaeControllerServiceStandardeventcollectorManagerServer.class);
    String serverPath;
    ManagementServer server;
    DcaeControllerServiceStandardeventcollectorManager controller;
...
//      LocationControllerApi api ;
    ...
    public DcaeControllerServiceStandardeventcollectorManagerServer(String filename) throws IOException {
        ...
        server = new ManagementServer(f, "ControllerServiceStandardeventcollectorManager", serverPath, filename);
        ManagementServer.setBuildVersion("ONAP-R2");
        server.addFactory(f);

		server.addFactory(org.openecomp.dcae.controller.service.standardeventcollector.service.ServiceFactory.eINSTANCE);
    ...
    public void runWebserver() throws IOException {
        controller = (DcaeControllerServiceStandardeventcollectorManager) server.find("/").o;
    ...
    public static void main(String []args) throws IOException {
            ...
            DcaeControllerServiceStandardeventcollectorManagerServer s = new DcaeControllerServiceStandardeventcollectorManagerServer("manager.properties");
            s.runWebserver();
    }
	public ControllerServiceStandardeventcollectorManager getController() {
		return controller;
	}
