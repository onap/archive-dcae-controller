...
package org.openecomp.dcae.controller.service.standardeventcollector.servers.manager.gui.logging;
...
public enum GuiClientApiMessageEnum implements EcompMessageEnum {
  ...
  REMOTE_CALL_FAILED_getGraph;
	...
	static {
		EELFResourceManager.loadMessageBundle("org/openecomp/dcae/controller/service/standardeventcollector/servers/manager/gui/logging/GuiClientApi");
	}
}
