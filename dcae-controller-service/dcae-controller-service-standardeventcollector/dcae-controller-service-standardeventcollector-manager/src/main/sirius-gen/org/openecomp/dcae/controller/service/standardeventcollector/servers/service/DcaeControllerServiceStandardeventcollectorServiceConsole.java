...
public class DcaeControllerServiceStandardeventcollectorServiceConsole extends Console {
	public static final Logger logger = Logger.getLogger(DcaeControllerServiceStandardeventcollectorServiceConsole.class);
    protected DcaeControllerServiceStandardeventcollectorServiceClient controller;
    



    public DcaeControllerServiceStandardeventcollectorServiceConsole(String filename, String name) {
            super(filename, name);
            controller = new DcaeControllerServiceStandardeventcollectorServiceClient(filename,name);
            client = controller.client;

    }
    
	public DcaeControllerServiceStandardeventcollectorServiceConsole(AbstractClient c) {
        controller = new DcaeControllerServiceStandardeventcollectorServiceClient(c);
        client = controller.client;
    }
