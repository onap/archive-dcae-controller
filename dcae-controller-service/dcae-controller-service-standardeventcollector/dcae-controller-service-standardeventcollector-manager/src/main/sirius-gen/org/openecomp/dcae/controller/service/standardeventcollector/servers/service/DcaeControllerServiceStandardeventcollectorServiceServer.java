...
public class DcaeControllerServiceStandardeventcollectorServiceServer implements ISiriusServer, IRequestHandler {
    public static final Logger logger = Logger.getLogger(DcaeControllerServiceStandardeventcollectorServiceServer.class);
    String serverPath;
    ManagementServer server;
    DcaeControllerServiceStandardeventcollectorService controller;
...
//      LocationControllerApi api ;
    ...
    public DcaeControllerServiceStandardeventcollectorServiceServer(String filename) throws IOException {
        ...
        server = new ManagementServer(f, "ControllerServiceStandardeventcollectorService", serverPath, filename);
    ...
    public void runWebserver() throws IOException {
        controller = (DcaeControllerServiceStandardeventcollectorService) server.find("/").o;
    ...
    public static void main(String []args) throws IOException {
            ...
            DcaeControllerServiceStandardeventcollectorServiceServer s = new DcaeControllerServiceStandardeventcollectorServiceServer("service.properties");
            s.runWebserver();
    }
	public ControllerServiceStandardeventcollectorService getController() {
		return controller;
	}
