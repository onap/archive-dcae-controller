...
public class ManagerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ManagerSwitch<Adapter> modelSwitch =
		new ManagerSwitch<Adapter>() {
			@Override
			public Adapter caseControllerServiceStandardeventcollectorManager(ControllerServiceStandardeventcollectorManager object) {
				return createControllerServiceStandardeventcollectorManagerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.openecomp.dcae.controller.service.standardeventcollector.manager.ControllerServiceStandardeventcollectorManager <em>Controller Service Standardeventcollector Manager</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createControllerServiceStandardeventcollectorManagerAdapter() {
		return null;
	}
