...
public class ManagerFactoryImpl extends EFactoryImpl implements ManagerFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ManagerPackage.CONTROLLER_SERVICE_STANDARDEVENTCOLLECTOR_MANAGER: return createControllerServiceStandardeventcollectorManager();
			default:
	 ...
	 * @generated
	 */
	public ControllerServiceStandardeventcollectorManager createControllerServiceStandardeventcollectorManager() {
		ControllerServiceStandardeventcollectorManagerImpl controllerServiceStandardeventcollectorManager = new ControllerServiceStandardeventcollectorManagerImpl();
		return controllerServiceStandardeventcollectorManager;
	}
